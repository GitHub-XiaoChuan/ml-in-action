...
def main():
    ...
    htmlFilename = "/Users/xingoo/PycharmProjects/ml-in-action/读书笔记《Python编程实战》/1创建型设计模式/login.html"
    htmlForm = create_login_form(HtmlFormBuilder())
    with open(htmlFilename, "w", encoding="utf-8") as file:
        file.write(htmlForm)
    print("wrote", htmlFilename)

    tkFilename = "/Users/xingoo/PycharmProjects/ml-in-action/读书笔记《Python编程实战》/1创建型设计模式/login.py"
...
# 基类为abc.ABCMeta，类无法被初始化，只能用作抽象类
