...
def main():
    if len(sys.argv) > 1 and sys.argv[1] == "-P":  # For regression testing
        ...
        return
    textFilename = "/Users/xingoo/PycharmProjects/ml-in-action/读书笔记《Python编程实战》/1创建型设计模式/diagram.txt"
    svgFilename = "/Users/xingoo/PycharmProjects/ml-in-action/读书笔记《Python编程实战》/1创建型设计模式/diagram.svg"
